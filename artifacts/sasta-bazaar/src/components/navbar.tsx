...
export function Navbar() {
  ...
  return (
    <header className="relative sticky top-0 z-40 grid min-h-32 w-full grid-cols-[auto_minmax(0,1fr)_auto] items-center border-b-4 border-primary bg-black px-3 shadow-[0_14px_30px_rgba(0,0,0,0.32)] sm:min-h-20 lg:min-h-32 lg:px-4">
      <div className="contents">
        <Link href="/" className="col-start-1 row-start-1 flex items-center hover:opacity-90 transition-opacity">
          <img
            ...
            className="h-28 w-auto max-w-[calc(100vw-120px)] rounded-md object-contain sm:h-20 sm:max-w-[300px] lg:h-32 lg:max-w-[460px]"
          />
        </Link>

        <nav className="absolute right-3 top-1/2 z-10 flex -translate-y-1/2 items-center justify-end gap-1.5 sm:static sm:col-start-3 sm:row-start-1 sm:translate-y-0 sm:gap-2 sm:pl-2 sm:pr-3 lg:gap-4 lg:pr-8">
